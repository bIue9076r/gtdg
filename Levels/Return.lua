...
function Return_Level:Load()
	...
	Return_Level.Tiles:Set(26,2,true,TileName["SH__L"])
	Return_Level.Tiles:Set(27,3,true,TileName["SH__L"])
	Return_Level.Tiles:Set(28,4,true,TileName["SH__L"])
	Return_Level.Tiles:Set(29,5,true,TileName["SH__L"])
	Return_Level.Tiles:Set(30,6,true,TileName["SH__L"])
	Return_Level.Tiles:Set(31,7,true,TileName["SH__L"])
	Return_Level.Tiles:Set(31,8,true,TileName["SH__L"])
	Return_Level.Tiles:Set(32,9,true,TileName["SH__L"])
	Return_Level.Tiles:Set(33,10,true,TileName["SH__L"])
	Return_Level.Tiles:Set(34,11,true,TileName["SH__L"])
	Return_Level.Tiles:Set(35,12,true,TileName["SH__L"])
	
	Return_Level.Tiles:Set(29,1,true,TileName["SH__R"])
	Return_Level.Tiles:Set(30,2,true,TileName["SH__R"])
	Return_Level.Tiles:Set(31,3,true,TileName["SH__R"])
	Return_Level.Tiles:Set(32,4,true,TileName["SH__R"])
	Return_Level.Tiles:Set(33,5,true,TileName["SH__R"])
	Return_Level.Tiles:Set(33,6,true,TileName["SH__R"])
	Return_Level.Tiles:Set(34,7,true,TileName["SH__R"])
	Return_Level.Tiles:Set(35,8,true,TileName["SH__R"])
